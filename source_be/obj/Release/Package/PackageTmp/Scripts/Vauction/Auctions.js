...
$(document).ready(function () {
  ...
  var grid_a = $("#a_list").jqGrid({
    ...
    height: '100%',
    width: items_table_w,
    colNames: ['Inventory#', 'Event', 'Lot', 'Status', 'Main Category', 'Category', 'Title', 'Price', 'Reserve', 'Shipping', 'QTY', 'Tags', 'Start Date', 'End Date', 'Commission', 'Consignor', 'Page Layout', 'LOA', 'Pulled Out', 'Unsold', 'Catlog', 'Old#', 'Listed Date', 'Entered By', 'Specialist', 'High Bidder', 'Current Bid'],
    colModel: [
