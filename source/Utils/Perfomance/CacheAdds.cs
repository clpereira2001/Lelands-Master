...
namespace Vauction.Utils.Perfomance
{
  ...
  public enum DataCacheRegionTypes { IMAGES, COUNTRIES, STATES, CATEGORIES, HOTNEWS, AUCTIONLISTS, AUCTIONS, WATCHLISTS, BIDS, EVENTS, EVENTREGISTRATIONS, INVOICES, USERS, TAGS };
  ...
  public static class DataCacheRegions
  {
    ...
    public static string HOTNEWS { get { return DataCacheRegionTypes.HOTNEWS.ToString(); } }
    ...
    public static string TAGS { get { return DataCacheRegionTypes.TAGS.ToString(); } }
  }
