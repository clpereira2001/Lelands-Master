...
namespace Vauction.Utils.Perfomance
{
  ...
  public enum CacheDataKeys { 
    ...
    EVENT_CURRENT, 
    EVENT_PASTEVENTS, 
    EVENT_CONSIGNORSEVENTS,
    EVENT_REGISTERFOREVENT,
    CATEGORY_GETLISTFORCATEGORY, 
    CATEGORY_GETEVENTCATEGORYBYID,
    CATEGORY_GETMAINCATEGORYBYID,
    CATEGORY_GETEVENTCATEGORYBYMAINCATEGORY,
    CATEGORY_GETEVENTCATEGORYDETAIL,
    CATEGORY_GETCATEGORIESMENU,
    CATEGORY_GETCATEGORIESTREE,    
    AUCTION_GETAUCTIONDETAIL,
    AUCTION_GETAUCTIONDETAILRESULT,
    AUCTION_GETAUCTIONDETAILRESULTPAST, 
    AUCTION_USERWATCHITEM,    
    AUCTION_GETLISTFORCATEGORY,
    AUCTION_GETBYCRITERIAS,
    AUCTION_GETAUCTIONRESULT,
    AUCTION_GETAUCTIONUPDATES,
    BID_GETBIDWATCHFORUSER,
    BID_GETUSERTOPBIDFORITEM,
    BID_ISUSERCANPARTICIPATEINBIDDING,
    DIFFERENT_GETCOUNTRYLIST,
    DIFFERENT_GETSTATELIST,
    DIFFERENT_GETSTATE,
    DIFFERENT_GETCOUNTRY,
    DIFFERENT_GETAUCTIONIMAGES,
    DIFFERENT_HOMEPAGEBUZZLIST,
    INVOICE_GETUSERINVOICE,
    INVOICE_GETCONSIGNMENTDETAILSBYCONSIGNMENTID,
    INVOICE_GETCONSIGNMENT,
    INVOICE_GETCONSIGNMENTTOTALS,
    USER_GETUSERBYEMAIL,
    USER_GETUSER,
    USER_GETADDRESSCARD,    
    USER_GETUSERREFERENCES,
